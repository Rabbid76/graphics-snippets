...
Intersection mesh::intersectRayAndTriangle(
    ...
    auto intersection = intersectRayAndPlane(ray, Plane::fromTriangle(p0, p1, p2));
    intersection.valid =
            intersection.valid &&
...
TriangleTriangleIntersection mesh::intersectTriangles(
        ...
        const float t1p1[],
        const float t1p2[]) {
    auto planeT1 = Plane::fromTriangle(t1p0, t1p1, t1p2);
    ...
    auto planeT0 = Plane::fromTriangle(t0p0, t0p1, t0p2);
