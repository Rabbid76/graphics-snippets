...
function generatePdSamplePointInitializer( samples: number, rings: number, radiusExponent: number ) {
...
function generateDenoiseSamples( numSamples: number, numRings: number, radiusExponent: number ) {
