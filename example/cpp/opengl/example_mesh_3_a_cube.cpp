...
void main()
{
    fragColor = vec4(vertUV.xy, (1.0-vertUV.x) * (1.0-vertUV.y),1.0);
}
)";
...
int main(void)
{
    ...
    glVertexAttribPointer( 0, 3, GL_FLOAT, GL_FALSE, 5*sizeof(*varray.data()), 0 );
    glVertexAttribPointer( 1, 2, GL_FLOAT, GL_FALSE, 5*sizeof(*varray.data()), (void*)(3*sizeof(*varray.data())) );    
