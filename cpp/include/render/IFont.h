...
public: 
  ...
  virtual bool DrawText( IDrawBufferProvider &buffer_provider, size_t textur_binding_id, const char *str, float height, float width_scale, const Render::TPoint3 &pos ) = 0; 
};
