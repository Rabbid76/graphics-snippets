...
/******************************************************************//**
* \brief Model, view and projection data  

The data layout follows the rules of GLSL/OpenGL `std140` and `std340`
standard.
...
public:
  ...
  virtual const TViewData & Data( void ) const = 0;
};
using TViewDataPtr = std::shared_ptr<IViewData>;
